'''
Purpose: Implementing TRANSFORMER Deep learning architecture for hybrid Audio and Force Data using Mel_Spectrogram data
...
save_dir = os.path.join(os.getcwd(), 'Confusion_Matrix_AdamW_0-30sec_Mel_Spectrogram')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

model_name = '0_30_Mel_Spectrogram'
maxlen = 130  # (orig = 323)

# ===================== AUDIO DATA====================
DATASET_PATH = "Audio_Preprocessed_Mel_Spectrogram_Labels_for_0_10_sec.json" # Audio_Preprocessed_Mel_Spectrogram_Labels.json
# =============OTHER CONSTANTS =====================
