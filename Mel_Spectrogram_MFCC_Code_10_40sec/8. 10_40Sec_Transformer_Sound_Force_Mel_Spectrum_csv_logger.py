...
save_dir = os.path.join(os.getcwd(), 'Confusion_Matrix_AdamW_10-40sec_Mel_Spectrogram') #RAdam AdamW
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

model_name = 'RAdam_10-40sec_Mel_Spectrogram' #AdamW
maxlen = 130  # (orig = 323)

# ===================== AUDIO DATA====================
DATASET_PATH = "10_40sec_Audio_Preprocessed_Mel_Spectrogram.json"
# =============OTHER CONSTANTS =====================
random_states =  [154] ## For plotting confusion matrix removed 4 iterations , 306, 743, 877, 558
test_accuracies = []
history_loss = []
history_accuracy = []
history_val_loss = []
