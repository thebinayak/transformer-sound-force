...
model_name = 'SoFo_Trans_model'
maxlen = 130  # (orig = 323)
random_stats = [154, 306, 743, 877, 558]

# ===================== AUDIO DATA====================
DATASET_PATH = "Audio_Preprocessed_Mel_Spectrogram_Labels.json"
# =============OTHER CONSTANTS =====================
random_states = [154, 306, 743, 877, 558]  # [154, 306]
test_accuracies = []
history_loss = []
history_accuracy = []
history_val_loss = []
...
if __name__ == "__main__":
    for idx in range(len(random_states)):
        ...
        csv_logger = CSVLogger("model_history_log" + str(idx) + ".csv", append=True)
    ...
    score, acc = model.evaluate([sound_validation, force_validation], stv_label, batch_size=8)
    hist_df = pd.DataFrame(history.history)
    hist_csv_file = f'histories/{model_name}_history_{idx+1}.csv'
